...
class Ec2Inventory(object):
    ...
    def add_instance(self, instance, region):
        ...
        # Set the environment
        # These are custom environment setup, which is done for distinguish
        # between UAT and prod environment
        # Currently setting environment as "UAT"
        self.push(self.inventory, "tag_Env_UAT", "localhost")
        self.inventory["tag_Env_UAT"] = list(set(self.inventory["tag_Env_UAT"]))

        # These are the unused variables to get the context
        # self.inventory["tag_Env_UAT"] = ['localhost']
        # self.inventory["_meta"]["hostvars"]["env"] = 'UAT'
        # self.inventory["env"] = 'UAT'
